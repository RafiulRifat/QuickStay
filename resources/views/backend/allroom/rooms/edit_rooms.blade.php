                                                    ...
                                                    <form class="row g-3" action="{{ route('update.room', $editData->id) }}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="file" name="multi_img[]" class="form-control" multiple id="multiling" accept="image/jpeg, image/jpg, image/gif, image/png">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="room_capacity" class="form-control" id="input3" value="{{ $editData->room_capacity }}">
                                                        </div>
